...
namespace InventoryManagement.Tests.IntegrationTests.Controllers
{
    ...
    public class ItemControllerTests : IClassFixture<WebApplicationFactory<Program>>
    {
        ...
        private readonly string _connectionString = "Server=sqlserver_tests,1433;Database=InventoryManagement;User Id=sa;Password=Strong!Password@123;TrustServerCertificate=True;";
